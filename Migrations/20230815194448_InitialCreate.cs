    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "richallan68@yahoo.com", "Richard", "Allan" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 3, "https://www.naturescampsites.com/app/uploads/2021/01/39327DC1-AB40-4B6A-B8BB-3758ADEC5215.jpeg", "Red Squirrel" },
                    { 3, 4, "https://bearfoottheory.com/wp-content/uploads/2018/05/Leave-No-Trace-campsite-tent.jpg", "White-Tailed Deer" },
                    { 4, 2, "https://www.tripsavvy.com/thmb/ZDXfkFTwAcC49Whakd2rlbwAysA=/2119x1414/filters:no_upscale():max_bytes(150000):strip_icc()/GettyImages-1016296534-020ab0eaccc847618acc38804a8a9cd2.jpg", "Great Tortoise" },
                    { 5, 1, "https://photos.thedyrt.com/photo/117425/media/california-atwell-mill_65e1e419b13a7d4d6424853413973488.jpg", "Coyote Cross" },
                    { 6, 4, "https://explorationsolo.com/wp-content/uploads/2022/01/Jacob-Branch-Primitive-Campsite.jpg", "Indian Moss" }
                });

            migrationBuilder.InsertData(
                table: "Reservations",
                columns: new[] { "Id", "CampsiteId", "CheckinDate", "CheckoutDate", "UserProfileId" },
                values: new object[] { 1, 4, new DateTime(2023, 8, 15, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2023, 8, 22, 0, 0, 0, 0, DateTimeKind.Local), 1 });
